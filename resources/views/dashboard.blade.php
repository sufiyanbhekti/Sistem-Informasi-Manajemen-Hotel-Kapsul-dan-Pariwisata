                            ...
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    <ul class="nav nav-pills ml-auto">
                                        <li class="nav-item">
                                            <a class="nav-link active" href="#revenue-chart" data-toggle="tab">Hotel</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="#sales-chart" data-toggle="tab">Wisata</a>
                                        </li>
                                    </ul>
                                </div>
                            </div><!-- /.card-header -->
                                ...
                                <div class="direct-chat-messages">
                                    ...
                                    <div class="direct-chat-msg">
                                        <div class="direct-chat-infos clearfix">
                                            <span class="direct-chat-name float-left">Bambang sekeluarga</span>
                                        ...
                                        <div class="direct-chat-text">
                                            Hotel nya bagus, kamarnya bersih,fasilitas lengkap, rekomend deh
                                        </div>
                                        <!-- /.direct-chat-text -->
                                    </div>
                                    <!-- /.direct-chat-msg -->
