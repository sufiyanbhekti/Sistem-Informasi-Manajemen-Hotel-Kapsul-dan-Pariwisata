                            ...
                            <form action="{{ route('penilaian.update',$penilaian->id_penilaian) }}" method="post">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nilai" class="form-control" value="{{$penilaian->nilai}}"
                                            id="exampleInputPassword1" placeholder="">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputPassword1">Tanggapan</label>
                                        <input type="text" name="tanggapan" class="form-control" value="{{$penilaian->tanggapan}}"
                                            id="exampleInputPassword1" placeholder="">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputPassword1">Kategori</label>
                                        <input type="text" name="kategori" class="form-control" value="{{$penilaian->kategori}}"
                                            id="exampleInputPassword1" placeholder="">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputPassword1">Tanggal Penilaian</label>
                                        <input type="date" name="tgl_penilaian" class="form-control" value="{{$penilaian->tgl_penilaian}}"
                                            id="exampleInputPassword1" placeholder="">
                                    </div>
                                </div>
                                <!-- /.card-body -->
