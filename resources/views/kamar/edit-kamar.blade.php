                            ...
                            <form action="{{ route('kamar.update',$kamar->id_kamar) }}" method="post">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="jenis_kamar" class="form-control" value="{{$kamar->jenis_kamar}}"
                                            id="exampleInputPassword1" placeholder="Enter Nama Pasien">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Status Kamar</label>
                                        <input type="text" name="status_kamar" class="form-control" value="{{$kamar->status_kamar}}"
                                            id="exampleInputEmail1" placeholder="Enter Alamat">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Harga Kamar</label>
                                        <input type="text" name="harga_kamar" class="form-control"value="{{$kamar->harga_kamar}}"
