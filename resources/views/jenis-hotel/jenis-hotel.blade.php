    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">List Jenis Hotel</h1>
                    </div><!-- /.col -->
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                            ...
                            <tbody>
                                ...
                                @foreach ($jenishotel as $p)
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $p->deskripsi }}</td>
                                        <td>
                                            <form action="{{ route('jenis-hotel.destroy', $p->id_jenis_hotel) }}"
                                                method="POST">
                        ...
                        {!! $jenishotel->links('vendor.pagination.bootstrap-4') !!}
