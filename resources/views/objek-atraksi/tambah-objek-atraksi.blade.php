                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card card-primary">
                            <!-- form start -->
                            <form action="{{ route('objek-atraksi.store') }}" method="post">
                                @csrf
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="tipe_atraksi" class="form-control"
                                            id="exampleInputPassword1" placeholder="Enter">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputPassword1">Kapasitas Atraksi</label>
                                        <input type="text" name="kapasitas_atraksi" class="form-control"
                                            id="exampleInputPassword1" placeholder="Enter">
                                    </div>
                                </div>
                                <!-- /.card-body -->
