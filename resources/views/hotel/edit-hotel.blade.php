                            ...
                            <form action="{{ route('hotel.update',$hotel->id_hotel) }}" method="post">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="alamat" class="form-control" value="{{$hotel->alamat}}"
                                            id="exampleInputEmail1" placeholder="Enter Alamat">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Deskripsi</label>
                                        <input type="text" name="deskripsi" class="form-control" value="{{$hotel->deskripsi}}"
                                        id="exampleInputEmail1">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Gambar Hotel</label>
                                        <input type="text" name="gambar_hotel" class="form-control" value="{{$hotel->gambar_hotel}}"
                                            id="exampleInputEmail1" placeholder="">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Check In</label>
                                        <input type="text" name="check_in" class="form-control" value="{{$hotel->check_in}}"
                                        id="exampleInputEmail1"
                                            placeholder="">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Check Out</label>
                                        <input type="text" name="check_out" class="form-control" value="{{$hotel->check_out}}"
                                            id="exampleInputEmail1" placeholder="">
                                    </div>
                                </div>
                                <!-- /.card-body -->
